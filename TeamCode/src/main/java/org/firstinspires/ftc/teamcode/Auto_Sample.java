...
//                    new double[]{1.0, 0.0001, 0.005, 0.0}, new double[]{0.12, 0.001, 0.01, 0.0}, new double[]{0.05, 0.02, 0.015, 0.0}, 0.0001, High_Chamber);
//
...
//                    new double[]{1.0, 0.01, 0.2, 0.0}, new double[]{0.07, 0.009, 0.009, 0.0}, new double[]{0.045, 0.009, 0.009, 0.0}, 0, 0);
//
//            keep(0.45);
//
//            move(1.0, 0.75, 0.7, -45.0, new double[]{0.15, 0.15, 0.15},
//                    new double[]{1.0, 0.01, 0.2, 0.0}, new double[]{0.07, 0.009, 0.009, 0.0}, new double[]{0.065, 0.009, 0.009, 0.0}, 0, 0);
//
//            place();
//
//            move(1.0, 1.1, 0.98, -125.0, new double[]{0.15, 0.15, 0.15},
//                    new double[]{1.0, 0.01, 0.2, 0.0}, new double[]{0.07, 0.009, 0.009, 0.0}, new double[]{0.09, 0.009, 0.009, 0.0}, 0, 0);
//
//            keep(0.45);
//
//            move(1.0, 0.95, 0.7, -45.0, new double[]{0.15, 0.15, 0.15},
//                    new double[]{1.0, 0.01, 0.2, 0.0}, new double[]{0.07, 0.009, 0.009, 0.0}, new double[]{0.055, 0.009, 0.009, 0.0}, 0, 0);
//
//            place();
//
//            SetServoPos(0, LA, RA);
...
//            SetServoPos(0, AG);
//
//            move(1.0, 1.2, 0.25, 180.0, new double[]{0.12, 0.15, 0.15},
...
////                    new double[]{2.2, 0.005, 0.3, 0.0}, new double[]{0.1, 0.005, 0.02, 0.0}, new double[]{0.1, 0.001, 0.002, 0.0}, 0.0001, 1100);
//
//            move(1.0, 1.9, 0.15, 0.0, new double[]{0.12, 0.15, 0.15},
