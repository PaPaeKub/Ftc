    ...
    public void runOpMode() {
        ...
        if (opModeIsActive()) {
            move(1.0, -0.15, 1.24, 0.0, new double[]{0.1, 0.15, 0.15},
                    new double[]{1.0, 0.0001, 0.03, 0.0}, new double[]{0.12, 0.0001, 0.01, 0.0}, new double[]{0.09, 0.00001, 0.015, 0.0}, 0.0001, High_Chamber);
            ...
            move(1.0, 0.68, 0.96, -125.0, new double[]{0.15, 0.15, 0.2},
                    new double[]{1.5, 0.0032, 0.2, 0.0}, new double[]{0.055, 0.0005, 0.009, 0.0}, new double[]{0.025, 0.0001, 0.009, 0.0}, 0, 0);
            ...
            move(1.0, 1.1, 0.91, -125.0, new double[]{0.15, 0.15, 0.2},
                    new double[]{1.5, 0.0032, 0.2, 0.0}, new double[]{0.065, 0.0001, 0.009, 0.0}, new double[]{0.045, 0.0001, 0.009, 0.0}, 0, 0);
