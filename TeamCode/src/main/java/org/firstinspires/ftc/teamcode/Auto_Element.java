...
public class Auto_Element extends Robot {
    ...
    public void runOpMode() {
        ...
        WaitForStart();
        if (opModeIsActive()) {
            move(1.0, -0.15, 1.2, 0.0, new double[]{0.1, 0.1, 0.1},
                    new double[]{2.0, 0.1, 0.3, 0.0}, new double[]{0.1, 0.001, 0.0005, 0.0}, new double[]{0.09, 0.001, 0.01, 0.0}, 0.0001, 1600);

            move(1.0, -0.15, 1.2, 0.0, new double[]{0.1, 0.1, 0.1},
                    new double[]{2.0, 0.1, 0.3, 0.0}, new double[]{0.09, 0.1, 0.01, 0.0}, new double[]{0.09, 0.001, 0.008, 0.0}, 0.0001, 1100);

            move(1.0, 1.0, 1.19, 0.0, new double[]{0.1, 0.1, 0.1},
                    new double[]{2.0, 0.1, 0.2, 0.0}, new double[]{0.25, 0.001, 0.009, 0.0}, new double[]{0.12, 0.0001, 0.009, 0.0}, 0, 0);



            move(1.0, 1.0, 2.2, 0.0, new double[]{0.1, 0.1, 0.1},
                    new double[]{2.0, 0.08, 0.1, 0.0}, new double[]{0.05, 0.01, 0.0009, 0.0}, new double[]{0.07, 0.0001, 0.008, 0.0}, 0, 0);

            move(1.0, 1.4, 0.5, 0.0, new double[]{0.1, 0.1, 0.1},
                    new double[]{2.0, 0.08, 0.1, 0.0}, new double[]{0.1, 0.01, 0.009, 0.0},  new double[]{0.07, 0.0001, 0.008, 0.0}, 0, 0);

            move(1.0, 1.4, 2.2, 0.0, new double[]{0.1, 0.1, 0.1},
                    new double[]{2.0, 0.08, 0.1, 0.0}, new double[]{0.05, 0.01, 0.0009, 0.0}, new double[]{0.07, 0.0001, 0.008, 0.0}, 0, 0);

            move(1.0, 1.8, 0.5, 0.0, new double[]{0.1, 0.1, 0.1},
                    new double[]{2.0, 0.08, 0.1, 0.0}, new double[]{0.1, 0.01, 0.009, 0.0},  new double[]{0.07, 0.0001, 0.008, 0.0}, 0, 0);



            move(1.0, 1.0, 0.4, 180.0, new double[]{0.1, 0.1, 0.1},
                    new double[]{2.0, 0.1, 0.3, 0.0}, new double[]{0.05, 0.07, 0.001, 0.0}, new double[]{0.08, 0.0001, 0.01, 0.0}, 0.001, 0);

            move(1.0, 1.0, 0.07, 180.0, new double[]{0.1, 0.1, 0.1},
                    new double[]{2.0, 0.1, 0.3, 0.0}, new double[]{0.09, 0.07, 0.03, 0.0}, new double[]{0.1, 0.0001, 0.01, 0.0}, 0.001, 0);



            move(1.0, -0.25, 1.19, 0.0, new double[]{0.1, 0.1, 0.1},
