...
public class Auto_Element extends Robot {
    ...
    public void runOpMode() {
        ...
        WaitForStart();
        if (opModeIsActive()) {
            move(0, -0.15, 1.07, 0.0, new double[]{0.3, 0.3, 0.3},
                    new double[]{2.0, 0.0001, 0.3, 0.0}, new double[]{1.2, 0.1, 0.035, 0.0}, new double[]{1.2, 0.1, 0.035, 0.0}, 0.0001, High_Chamber);

            clips();

            move(0, 1.0, 0.8, 0.0, new double[]{0.3, 0.3, 0.3},
                    new double[]{1.0, 0.0001, 0.3, 0.0}, new double[]{1.0, 0.1, 0.01, 0.0}, new double[]{0.3, 0.1, 0.035, 0.0}, 0.0001, 0);

            move(0, 1.25, 2.4, 0.0, new double[]{0.3, 0.3, 0.3},
                    new double[]{1.0, 0.0001, 0.3, 0.0}, new double[]{1.0, 0.1, 0.01, 0.0}, new double[]{0.3, 0.1, 0.035, 0.0}, 0.0001, 0);

            move(0, 1.4, 0.5, 0.0, new double[]{0.3, 0.3, 0.3},
                    new double[]{1.0, 0.0001, 0.3, 0.0}, new double[]{2.0, 0.1, 0.09, 0.0}, new double[]{0.3, 0.1, 0.035, 0.0}, 0.0001, 0);

            move(0, 1.65, 2.4, 0.0, new double[]{0.3, 0.3, 0.3},
                    new double[]{1.0, 0.0001, 0.3, 0.0}, new double[]{1.0, 0.1, 0.01, 0.0}, new double[]{0.3, 0.1, 0.035, 0.0}, 0.0001, 0);

            move(0, 1.8, 0.5, 0.0, new double[]{0.3, 0.3, 0.3},
                    new double[]{1.0, 0.0001, 0.3, 0.0}, new double[]{2.0, 0.1, 0.09, 0.0}, new double[]{0.3, 0.1, 0.035, 0.0}, 0.0001, 0);

            move(0, 1.9, 2.4, 0.0, new double[]{0.3, 0.3, 0.3},
                    new double[]{1.0, 0.0001, 0.3, 0.0}, new double[]{1.0, 0.1, 0.01, 0.0}, new double[]{0.3, 0.1, 0.035, 0.0}, 0.0001, 0);

            move(0, 2.05, 0.5, 0.0, new double[]{0.3, 0.3, 0.3},
                    new double[]{1.0, 0.0001, 0.3, 0.0}, new double[]{2.0, 0.1, 0.09, 0.0}, new double[]{0.3, 0.1, 0.035, 0.0}, 0.0001, 0);

            SetServoPos(0.72, LLG, RLG);
            SetServoPos(0.2, D);

            move(0.4, 1.0, 0.6, 180.0, new double[]{0.3, 0.3, 0.3},
                    new double[]{2.0, 0.001, 0.009, 0.0}, new double[]{0.12, 0.001, 0.009, 0.0}, new double[]{0.3, 0.1, 0.25, 0.0}, 0.1, 0);

            move(0.4, 1.0, 0.25, 180.0, new double[]{0.3, 0.3, 0.3},
            ...
            move(0.4, -0.35, 1.07, 0.0, new double[]{0.25, 0.25, 0.25},
